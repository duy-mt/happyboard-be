    ...
    up: async (queryInterface, Sequelize) => {
        await queryInterface.bulkInsert(
            ...
            [
                ...
                {
                    title: 'Những món quà Tết truyền thống',
                    content: `
                            <p>Quà Tết truyền thống như bánh chưng, mứt Tết, và trà là lựa chọn tuyệt vời để thể hiện sự trân trọng với người thân.</p>
                            <img src="https://res.cloudinary.com/daokqrkdk/image/upload/v1735078150/tet_traditional.jpg" alt="Quà Tết truyền thống" />
                        `,
                    userId: 1,
                    groupId: 1,
                    categoryId: 1,
                ...
                {
                    title: 'Quà Tết cho đồng nghiệp',
                    content: `
                            <p>Hộp quà tặng văn phòng phẩm hoặc set quà sức khỏe như trà, mật ong là lựa chọn thiết thực cho đồng nghiệp.</p>
                        `,
                    userId: 2,
                    groupId: 1,
                    categoryId: 1,
                ...
                {
                    title: 'Thiết kế không gian làm việc sáng tạo',
                    content: `
                            <p>Sử dụng đèn LED, ghế ngồi tiện nghi và cây xanh để nâng cấp không gian làm việc của bạn.</p>
                            <p>Tham khảo mẫu thiết kế tại <a href="https://example.com/creative-space">đây</a>.</p>
                        `,
                    userId: 3,
                    groupId: 1,
                    categoryId: 2,
                ...
                {
                    title: 'Trang bị công nghệ cho văn phòng',
                    content: `
                            <p>Đầu tư vào màn hình 4K, tai nghe chống ồn và bàn phím cơ để tăng năng suất làm việc.</p>
                        `,
                    userId: 4,
                    groupId: 1,
                    categoryId: 2,
                ...
                {
                    title: 'Công thức làm bún chả tại nhà',
                    content: `
                            <p>Bún chả là món ăn dễ làm và ngon miệng. Chuẩn bị nguyên liệu tươi ngon và thử ngay hôm nay!</p>
                        `,
                    userId: 5,
                    groupId: 1,
                    categoryId: 3,
                ...
                {
                    title: 'Thử các món ăn đường phố Việt Nam',
                    content: `
                            <p>Bánh mì, bánh tráng nướng, và nước mía là những món ăn đường phố không thể bỏ qua!</p>
                            <img src="https://res.cloudinary.com/daokqrkdk/image/upload/v1735078200/street_food.jpg" alt="Món ăn đường phố" />
                        `,
                    userId: 5,
                    groupId: 1,
                    categoryId: 3,
                ...
                {
                    title: 'Chạy bộ mỗi sáng để tăng sức bền',
                    content: `
                            <p>Chạy bộ là cách đơn giản để cải thiện sức khỏe và giảm căng thẳng. Thử chạy bộ mỗi sáng 30 phút!</p>
                        `,
                    userId: 4,
                    groupId: 1,
                    categoryId: 4,
                ...
                {
                    title: 'Yoga buổi tối giúp thư giãn',
                    content: `
                            <p>Bài tập yoga buổi tối giúp bạn thư giãn sau một ngày làm việc. Tham khảo video hướng dẫn tại <a href="https://example.com/evening-yoga">đây</a>.</p>
                        `,
                    userId: 3,
                    groupId: 1,
                    categoryId: 4,
                ...
                {
                    title: 'Bắt đầu học lập trình Python',
                    content: `
                            <p>Python là ngôn ngữ lập trình phổ biến và dễ học, phù hợp cho người mới bắt đầu.</p>
                            <p><a href="https://example.com/python-tutorial">Tham khảo tài liệu học Python</a>.</p>
                        `,
                    userId: 2,
                    groupId: 1,
                    categoryId: 5,
                ...
                },
                {
                    ...
                    content: `
                            <p>AI tiếp tục là xu hướng hàng đầu với các ứng dụng trong giáo dục, y tế, và thương mại. Khám phá thêm về AI tại <a href="https://example.com/ai-trends-2024">đây</a>.</p>
                        `,
                    userId: 2,
                    groupId: 1,
                    categoryId: 5,
