...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('role_has_permissions', [
      ...
      { roleId: 2, permissionId: 11, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 12, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 13, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 14, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 15, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 16, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 17, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 2, permissionId: 18, createdAt: new Date(), updatedAt: new Date() },
      ...
      { roleId: 3, permissionId: 12, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 3, permissionId: 14, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 3, permissionId: 15, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 3, permissionId: 16, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 3, permissionId: 17, createdAt: new Date(), updatedAt: new Date() },
      ...
      { roleId: 4, permissionId: 12, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 4, permissionId: 14, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 4, permissionId: 16, createdAt: new Date(), updatedAt: new Date() },
      { roleId: 4, permissionId: 17, createdAt: new Date(), updatedAt: new Date() }
    ], {});
  },
